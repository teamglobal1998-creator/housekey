...
export default function Navbar() {
    ...
    return (
        <nav className={`fixed w-full z-50 transition-all duration-300 ${isWhiteNav ? "bg-white shadow-md py-4" : "bg-transparent py-6"
            ...
            {/* Mobile Nav */}
            {isOpen && (
                <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-xl py-6 flex flex-col items-center gap-6 font-bold text-primary uppercase text-xs tracking-widest">
